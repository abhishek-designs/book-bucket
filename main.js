...
UI.prototype.removeBook = function (target) {
  ...
  if (target.classList.contains("btn-remove")) {
    ...
    // Creating Store instance to remove book from the storage also
...
UI.prototype.showMsg = function (message, msgClass) {
...
Store.prototype.storeBooks = function (book) {
...
Store.prototype.fetchBooks = function () {
  // Get the books after checking the storage
  const books = this.checkStorage();
...
bookForm.addEventListener("submit", function (e) {
  ...
  // Creating a Store instance to store the books into the local storage
  const store = new Store();
